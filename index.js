...
// // var GreensKiosk = require('./products');
...
// const productList = document.querySelector('.productItem');
...
//                         <ul id = "fruList">${product.name}</ul>
//                         <ul id = "vegList">${product.name}</ul>
//                         <ul id = "products">${product.name}</ul>
